...
def compile_js(manifest,config):
	js_file = os.path.join(cwd,'assets','com.krilab.xtremepush.js')
...
""" % module_assets
	...
	assets_router = os.path.join(cwd,'Classes','ComKrilabXtremepushModuleAssets.m')
...
def package_module(manifest,mf,config):
	...
	xpush_lib = os.path.join(cwd,'XtremePush_iOS','libXPush.a')
	if os.path.exists(xpush_lib):
		zf.write(xpush_lib,'%s/libXPush.a' % modulepath)
